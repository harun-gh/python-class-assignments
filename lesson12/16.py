...
def main():
    ...
    replace_key(dictionary, "千葉県千葉市", "千葉県")
    replace_key(dictionary, "千葉県柏市", "千葉県")
    replace_key(dictionary, "千葉県船橋市", "千葉県")
    replace_key(dictionary, "千葉県市川市", "千葉県")
    make_bar_graph(dict(sorted(dictionary.items(), key=lambda x: x[1], reverse=True)))
    print("make graph")
